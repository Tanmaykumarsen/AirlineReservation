            ...
            <div class="container-fluid h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4 page-title">
                    	<h3 class="text-white">Welcome to Flight-Reservation Dashboard <?php echo $_SESSION['setting_name']; ?></h3>
                        <hr class="divider my-4" />
                    <div class="col-md-12 mb-2 text-left">
                        <div class="card">
                            <div class="card-body">
                                <form id="manage-filter" action="flight.php" method="POST">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-3 offset-sm-5">
                                            <button class="btn btn-block btn-sm btn-primary" onclick="location.href='flights.php'">
                                                <i class="fa fa-plane-departure"></i> Find Flights
                                            </button>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="port-content text-center">
                           <a href="flights.php" class="btn-primary btn">Find Flights</a>
                        </div>
                        </div>
                    </div>
                    <?php endwhile; ?>
